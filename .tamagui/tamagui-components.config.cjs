...
var require_cjs = __commonJS({
  "node_modules/@tamagui/use-force-update/dist/cjs/index.js"(exports, module2) {
    ...
    function useForceUpdate2() {
      return isServerSide2 ? idFn3 : (0, import_react45.useReducer)((x) => Math.random(), 0)[1];
    }
...
var require_LayoutGroupContext = __commonJS({
  "node_modules/@tamagui/animate-presence/dist/cjs/LayoutGroupContext.js"(exports, module2) {
    ...
    var import_react45 = require("react");
    var LayoutGroupContext2 = (0, import_react45.createContext)({});
  }
});
...
var require_PresenceContext = __commonJS({
  "node_modules/@tamagui/use-presence/dist/cjs/PresenceContext.js"(exports, module2) {
    ...
    var import_react45 = require("react");
    var PresenceContext2 = (0, import_react45.createContext)(null);
  }
});
...
var require_usePresence = __commonJS({
  "node_modules/@tamagui/use-presence/dist/cjs/usePresence.js"(exports, module2) {
    ...
    function usePresence2() {
      const context = (0, import_react45.useContext)(import_PresenceContext2.PresenceContext);
      if (!context)
        return [true, null, context];
      const { isPresent: isPresent22, onExitComplete, register } = context, id = (0, import_react45.useId)() || "";
      return (0, import_react45.useEffect)(() => register(id), [id, register]), !isPresent22 && onExitComplete ? [false, () => onExitComplete == null ? void 0 : onExitComplete(id), context] : [true, void 0, context];
    }
    __name(usePresence2, "usePresence");
    function useIsPresent2() {
      return isPresent2((0, import_react45.useContext)(import_PresenceContext2.PresenceContext));
    }
...
var require_PresenceChild = __commonJS({
  "node_modules/@tamagui/animate-presence/dist/cjs/PresenceChild.js"(exports, module2) {
    ...
    var PresenceChild2 = /* @__PURE__ */ __name(({
      ...
      const presenceChildren = React39.useMemo(newChildrenMap2, []), id = (0, import_react45.useId)() || "", context = React39.useMemo(
        () => ({
          id,
          initial,
          isPresent: isPresent2,
...
var require_AnimatePresence = __commonJS({
  "node_modules/@tamagui/animate-presence/dist/cjs/AnimatePresence.js"(exports, module2) {
    ...
    var import_web16 = require("@tamagui/core");
    var import_react45 = __toESM2(require("react"));
    ...
    function onlyElements2(children) {
      const filtered = [];
      return import_react45.Children.forEach(children, (child, index3) => {
        (0, import_react45.isValidElement)(child) && (!child.key && import_react45.Children.count(children) > 1 ? (process.env.NODE_ENV === "development" && console.warn("No key given to AnimatePresence child, assigning index as key"), filtered.push(
          import_react45.default.cloneElement(child, {
            key: index3
          })
        )) : filtered.push(child));
      }), filtered;
    ...
    var AnimatePresence2 = /* @__PURE__ */ __name(({
      ...
      const isClientMounted = (0, import_web16.useDidFinishSSR)(), forceRenderLayoutGroup = (0, import_react45.useContext)(import_LayoutGroupContext2.LayoutGroupContext).forceRender;
      forceRenderLayoutGroup && (forceRender = forceRenderLayoutGroup);
      const isMounted = (0, import_react45.useRef)(false), filteredChildren = onlyElements2(children);
      let childrenToRender = filteredChildren;
      const exiting = /* @__PURE__ */ new Set(), presentChildren = (0, import_react45.useRef)(childrenToRender), allChildren = (0, import_react45.useRef)(/* @__PURE__ */ new Map()).current, isInitialRender = (0, import_react45.useRef)(true);
      (0, import_react45.useEffect)(() => (isMounted.current = true, () => {
      ...
      const hasWarned = process.env.NODE_ENV === "development" ? (0, import_react45.useRef)(false) : null;
      ...
      }), /* @__PURE__ */ (0, import_jsx_runtime51.jsx)(import_jsx_runtime51.Fragment, { children: exiting.size ? childrenToRender : childrenToRender.map((child) => (0, import_react45.cloneElement)(child)) });
    }, "AnimatePresence");
...
var require_useGet = __commonJS({
  "node_modules/@tamagui/use-event/dist/cjs/useGet.js"(exports, module2) {
    ...
    var useIsomorphicLayoutEffect15 = !isWeb30 || isClient7 ? import_react45.useLayoutEffect : import_react45.useEffect;
    function useGet6(currentValue, initialValue2, forwardToFunction) {
      const curRef = (0, import_react45.useRef)(initialValue2 ?? currentValue);
...
var require_useControllableState = __commonJS({
  "node_modules/@tamagui/use-controllable-state/dist/cjs/useControllableState.js"(exports, module2) {
    ...
    function useControllableState2({
      ...
      const [state, setState] = (0, import_react45.useState)(prop ?? defaultProp), previous = (0, import_react45.useRef)(state), propWins = strategy === "prop-wins" && prop !== void 0, value = propWins ? prop : state, onChangeCb = (0, import_use_event3.useEvent)(onChange || idFn3), transitionFn = transition ? import_react45.startTransition : emptyCallbackFn2;
      (0, import_react45.useEffect)(() => {
        prop !== void 0 && (previous.current = prop, transitionFn(() => {
          setState(prop);
        }));
      }, [prop]), (0, import_react45.useEffect)(() => {
  ...
  "node_modules/@tamagui/collection/dist/cjs/Collection.js"(exports, module2) {
    ...
    function createCollection2(name) {
      const PROVIDER_NAME = name + "CollectionProvider", [createCollectionContext, createCollectionScope2] = (0, import_create_context16.createContextScope)(PROVIDER_NAME), [CollectionProviderImpl, useCollectionContext] = createCollectionContext(PROVIDER_NAME, {
        ...
        const { scope, children } = props, ref = import_react45.default.useRef(null), itemMap = import_react45.default.useRef(/* @__PURE__ */ new Map()).current;
        return /* @__PURE__ */ (0, import_jsx_runtime51.jsx)(CollectionProviderImpl, { scope, itemMap, collectionRef: ref, children });
      }, "CollectionProvider");
      CollectionProvider.displayName = PROVIDER_NAME;
      const COLLECTION_SLOT_NAME = name + "CollectionSlot", CollectionSlot = import_react45.default.forwardRef(
        (props, forwardedRef) => {
          ...
          return /* @__PURE__ */ (0, import_jsx_runtime51.jsx)(import_core54.Slot, { ref: composedRefs, children });
        }
      );
      CollectionSlot.displayName = COLLECTION_SLOT_NAME;
      const ITEM_SLOT_NAME = name + "CollectionItemSlot", ITEM_DATA_ATTR = "data-collection-item", CollectionItemSlot = import_react45.default.forwardRef(
        (props, forwardedRef) => {
          const { scope, children, ...itemData } = props, ref = import_react45.default.useRef(null), composedRefs = (0, import_compose_refs17.useComposedRefs)(forwardedRef, ref), context = useCollectionContext(ITEM_SLOT_NAME, scope);
          return import_react45.default.useEffect(() => (context.itemMap.set(ref, { ref, ...itemData }), () => void context.itemMap.delete(ref))), /* @__PURE__ */ (0, import_jsx_runtime51.jsx)(import_core54.Slot, { [ITEM_DATA_ATTR]: "", ref: composedRefs, children });
        }
      );
      CollectionItemSlot.displayName = ITEM_SLOT_NAME;
      function useCollection2(scope) {
        const context = useCollectionContext(name + "CollectionConsumer", scope);
        return import_react45.default.useCallback(() => {
...
var require_getElevation = __commonJS({
  "node_modules/@tamagui/stacks/dist/cjs/getElevation.js"(exports, module2) {
    ...
    var getElevation2 = /* @__PURE__ */ __name((size2, extras) => {
      if (!size2)
        return;
      const { tokens } = extras, token = tokens.size[size2], sizeNum = (0, import_core54.isVariable)(token) ? +token.val : size2;
...
var require_cjs13 = __commonJS({
  "node_modules/@tamagui/get-font-sized/dist/cjs/index.js"(exports, module2) {
    ...
    function getDefaultSizeToken(font) {
      ...
      const sizeTokens = "$true" in font.size ? font.size : (0, import_core54.getTokens)().size, sizeDefault = sizeTokens.$true, sizeDefaultSpecific = sizeDefault ? Object.keys(sizeTokens).find(
...
var require_Image = __commonJS({
  "node_modules/@tamagui/image/dist/cjs/Image.js"(exports, module2) {
    ...
    var Image2 = StyledImage.extractable(
      (0, import_react45.forwardRef)((inProps, ref) => {
        const props = (0, import_core54.useProps)(inProps), { src, source, ...rest } = props;
...
var require_getFontSize = __commonJS({
  "node_modules/@tamagui/font-size/dist/cjs/getFontSize.js"(exports, module2) {
    ...
    var getFontSize4 = /* @__PURE__ */ __name((inSize, opts) => {
      ...
      return (0, import_core54.isVariable)(res) ? +res.val : res ? +res : 16;
    }, "getFontSize");
    var getFontSizeVariable = /* @__PURE__ */ __name((inSize, opts) => {
      const token = getFontSizeToken(inSize, opts);
      return token ? (0, import_core54.getConfig)().fontsParsed[(opts == null ? void 0 : opts.font) || "$body"].size[token] : inSize;
    }, "getFontSizeVariable");
    var getFontSizeToken = /* @__PURE__ */ __name((inSize, opts) => {
      if (typeof inSize == "number")
        return null;
      const relativeSize = (opts == null ? void 0 : opts.relativeSize) || 0, fontSize = (0, import_core54.getConfig)().fontsParsed[(opts == null ? void 0 : opts.font) || "$body"].size, size2 = inSize || ("$true" in fontSize ? "$true" : "$4"), sizeTokens = Object.keys(fontSize);
...
var require_cjs21 = __commonJS({
  "node_modules/@tamagui/constants/dist/cjs/index.js"(exports, module2) {
    ...
    var useIsomorphicLayoutEffect15 = isServer2 ? import_react45.useEffect : import_react45.useLayoutEffect;
...
var require_useGetThemedIcon = __commonJS({
  "node_modules/@tamagui/helpers-tamagui/dist/cjs/useGetThemedIcon.js"(exports, module2) {
    ...
    var useGetThemedIcon4 = /* @__PURE__ */ __name((props) => {
      ...
      return (el) => el && ((0, import_react45.isValidElement)(el) ? (0, import_react45.cloneElement)(el, {
        ...props,
        color,
        // @ts-expect-error
        ...el.props
      }) : (0, import_react45.createElement)(el, props));
    }, "useGetThemedIcon");
  }
});
...
var require_focusableInputHOC = __commonJS({
  "node_modules/@tamagui/focusable/dist/cjs/focusableInputHOC.js"(exports, module2) {
    ...
    function useFocusable2({
      ...
      const { id, onChangeText, value, defaultValue: defaultValue2 } = props, inputValue = (0, import_react45.useRef)(value || defaultValue2 || ""), unregisterFocusable = (0, import_react45.useRef)(), inputRef = (0, import_react45.useCallback)(
        (input) => {
          var _a;
...
var require_Group = __commonJS({
  "node_modules/@tamagui/group/dist/cjs/Group.js"(exports, module2) {
    ...
    var GroupFrame = (0, import_core54.styled)(import_stacks25.ThemeableStack, {
      name: "GroupFrame",
      variants: {
        unstyled: {
          false: {
    ...
    function createGroup(verticalDefault) {
      return (0, import_core54.withStaticProperties)(
        (0, import_react45.forwardRef)((props, ref) => {
          const activeProps = (0, import_core54.useProps)(props), {
            ...
            forceUseItem,
            ...restProps
          } = (0, import_core54.getExpandedShorthands)(activeProps), vertical = orientation === "vertical", [itemChildrenCount, setItemChildrenCount] = (0, import_use_controllable_state15.useControllableState)({
            defaultProp: forceUseItem ? 1 : 0
          }), isUsingItems = itemChildrenCount > 0, radius = borderRadius ?? (size2 ? (0, import_core54.getVariableValue)((0, import_core54.getTokens)().radius[size2]) - 1 : void 0), disablePassBorderRadius = disablePassBorderRadiusProp ?? !(radius !== void 0), childrenArray = import_react45.Children.toArray(childrenProp), children = isUsingItems ? import_react45.Children.toArray(childrenProp).filter(import_react45.isValidElement) : childrenArray.map((child, i) => {
          ...
          ), onItemMount = import_react45.default.useCallback(
            () => setItemChildrenCount((prev) => prev + 1),
            []
          ), onItemUnmount = import_react45.default.useCallback(
            () => setItemChildrenCount((prev) => prev - 1),
            []
          );
          return /* @__PURE__ */ (0, import_jsx_runtime51.jsx)(
    ...
    var GroupItem = /* @__PURE__ */ __name((props) => {
      ...
      const { __scopeGroup, children, forcePlacement } = props, groupItemProps = useGroupItem3(
        { disabled: (0, import_react45.isValidElement)(children) ? children.props.disabled : void 0 },
        forcePlacement,
        __scopeGroup
      );
      return (0, import_react45.isValidElement)(children) ? (0, import_core54.isTamaguiElement)(children) ? import_react45.default.cloneElement(children, groupItemProps) : import_react45.default.cloneElement(children, {
        style: {
    ...
    var useGroupItem3 = /* @__PURE__ */ __name((childrenProps, forcePlacement, __scopeGroup) => {
      ...
      if (import_react45.default.useEffect(() => (context.onItemMount(), () => {
    ...
    var cloneElementWithPropOrder = /* @__PURE__ */ __name((child, props) => {
      ...
      return import_react45.default.cloneElement({ ...child, props: null }, next);
...
var require_mutateTheme = __commonJS({
  "node_modules/@tamagui/theme/dist/cjs/_mutateTheme.js"(exports, module2) {
    ...
    function mutateThemes2({
      ...
      return (0, import_react45.startTransition)(() => {
...
__export(esm_exports2, {
  ...
  setupReactNative: () => import_core53.setupReactNative,
...
function createSwitch({ Frame: Frame2, Thumb: Thumb2, acceptsUnstyled }) {
  const SwitchThumb2 = Thumb2.styleable(function(props, forwardedRef) {
    const { size: sizeProp, ...thumbProps } = props, { disabled, checked, unstyled, frameWidth } = React31.useContext(SwitchContext), [thumbWidth, setThumbWidth] = React31.useState(0), initialChecked = React31.useRef(checked).current, distance = frameWidth - thumbWidth;
    return (
      // @ts-ignore
      /* @__PURE__ */ (0, import_jsx_runtime38.jsx)(
        Thumb2,
        {
          ...
          ...thumbProps,
          onLayout: (0, import_core38.composeEventHandlers)(
            props.onLayout,
            (e) => (
              // @ts-ignore
    ...
    React31.forwardRef(function(propsIn, forwardedRef) {
      const styledContext = React31.useContext(SwitchContext), props = (0, import_core38.useProps)(propsIn), {
        ...
        return acceptsUnstyled && _ === void 0 && unstyled === false && (_ = 2), typeof _ == "string" && (_ = (0, import_core38.getVariableValue)((0, import_get_token8.getSize)(_))), +_;
      })(), native = Array.isArray(nativeProp) ? nativeProp : [nativeProp], shouldRenderMobileNative = !import_core38.isWeb && nativeProp === true || !import_core38.isWeb && native.includes("mobile") || native.includes("android") && import_react_native10.Platform.OS === "android" || native.includes("ios") && import_react_native10.Platform.OS === "ios", [button, setButton] = React31.useState(null), composedRefs = useComposedRefs(forwardedRef, (node) => setButton(node)), labelId = useLabelContext(button), labelledBy = ariaLabelledby || labelId, hasConsumerStoppedPropagationRef = React31.useRef(false), isFormControl = import_core38.isWeb ? button ? !!button.closest("form") : true : false, [frameWidth, setFrameWidth] = React31.useState(0), [checked = false, setChecked] = useControllableState({
        prop: checkedProp,
      ...
      return shouldRenderMobileNative ? /* @__PURE__ */ (0, import_jsx_runtime38.jsx)(
      ...
      ) : (import_core38.isWeb || React31.useEffect(() => {
        if (props.id)
        ...
        /* @__PURE__ */ (0, import_jsx_runtime38.jsx)(
          Frame2,
          {
            ...
            ...switchProps,
            ref: composedRefs,
            onPress: (0, import_core38.composeEventHandlers)(props.onPress, (event) => {
              setChecked((prevChecked) => !prevChecked), import_core38.isWeb && isFormControl && (hasConsumerStoppedPropagationRef.current = event.isPropagationStopped(), hasConsumerStoppedPropagationRef.current || event.stopPropagation());
            }),
            onLayout: (0, import_core38.composeEventHandlers)(
              props.onLayout,
              (e) => (
  ...
  __name(getState5, "getState");
  return (0, import_core38.withStaticProperties)(SwitchComponent, {
    Thumb: SwitchThumb2
  });
}
...
var getSwitchHeight = /* @__PURE__ */ __name((val) => Math.round((0, import_core39.getVariableValue)((0, import_get_token9.getSize)(val)) * 0.65), "getSwitchHeight");
...
function createCollection(name) {
  ...
  const COLLECTION_SLOT_NAME = name + "CollectionSlot", CollectionSlot = import_react38.default.forwardRef(
    (props, forwardedRef) => {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime39.jsx)(import_core40.Slot, { ref: composedRefs, children });
    }
  );
  CollectionSlot.displayName = COLLECTION_SLOT_NAME;
  const ITEM_SLOT_NAME = name + "CollectionItemSlot", ITEM_DATA_ATTR = "data-collection-item", CollectionItemSlot = import_react38.default.forwardRef(
    (props, forwardedRef) => {
      ...
      return import_react38.default.useEffect(() => (context.itemMap.set(ref, { ref, ...itemData }), () => void context.itemMap.delete(ref))), /* @__PURE__ */ (0, import_jsx_runtime39.jsx)(import_core40.Slot, { [ITEM_DATA_ATTR]: "", ref: composedRefs, children });
    }
  );
  CollectionItemSlot.displayName = ITEM_SLOT_NAME;
  function useCollection2(scope) {
...
var RovingFocusGroupImpl = React33.forwardRef((props, forwardedRef) => {
  ...
  }), [isTabbingBackOut, setIsTabbingBackOut] = React33.useState(false), handleEntryFocus = (0, import_core41.useEvent)(onEntryFocus), getItems = useCollection(__scopeRovingFocusGroup), isClickFocusRef = React33.useRef(false), [focusableItemsCount, setFocusableItemsCount] = React33.useState(0);
    ...
    RovingFocusProvider,
    {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime40.jsx)(
        import_core41.Stack,
        {
          ...
          onMouseDown: (0, import_core41.composeEventHandlers)(props.onMouseDown, () => {
            isClickFocusRef.current = true;
          }),
          onFocus: (0, import_core41.composeEventHandlers)(props.onFocus, (event) => {
          ...
          onBlur: (0, import_core41.composeEventHandlers)(
            props.onBlur,
    ...
    Collection.ItemSlot,
    {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime40.jsx)(
        import_core41.Stack,
        {
          ...
          ...itemProps,
          ref: forwardedRef,
          onMouseDown: (0, import_core41.composeEventHandlers)(props.onMouseDown, (event) => {
            focusable ? context.onItemFocus(id) : event.preventDefault();
          }),
          onFocus: (0, import_core41.composeEventHandlers)(props.onFocus, () => context.onItemFocus(id)),
          ...import_core41.isWeb && {
            onKeyDown: (0, import_core41.composeEventHandlers)(
              props.onKeyDown,
              (event) => {
...
var RovingFocusGroup = (0, import_core41.withStaticProperties)(
  React33.forwardRef(
...
var TooltipComponent = React37.forwardRef(function(props, ref) {
  ...
  }), id = props.groupId, onOpenChange = (0, import_core42.useEvent)((open2) => {
...
var Tooltip2 = (0, import_core42.withStaticProperties)(TooltipComponent, {
  Anchor: PopoverAnchor,
  Arrow: TooltipArrow,
...
var createTamagui = process.env.NODE_ENV !== "development" ? import_core43.createTamagui : (conf) => {
  const sizeTokenKeys = ["$true"], hasKeys = /* @__PURE__ */ __name((expectedKeys, obj) => expectedKeys.every((k) => typeof obj[k] < "u"), "hasKeys"), tamaguiConfig = (0, import_core43.createTamagui)(conf);
...
var TamaguiProvider = /* @__PURE__ */ __name(({ children, ...props }) => /* @__PURE__ */ (0, import_jsx_runtime46.jsx)(import_core44.TamaguiProvider, { ...props, children: /* @__PURE__ */ (0, import_jsx_runtime46.jsx)(PortalProvider, { shouldAddRootHost: true, children }) }), "TamaguiProvider");
...
var AnchorFrame = (0, import_core45.styled)(SizableText, {
  name: "Anchor",
  tag: "a",
  accessibilityRole: "link"
});
var Anchor = AnchorFrame.extractable(
  (0, import_react44.forwardRef)(({ href, target, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime47.jsx)(
    AnchorFrame,
    {
      ...props,
      ...import_core45.isWeb ? {
...
var EnsureFlexed = (0, import_core46.styled)(import_core46.Text, {
  opacity: 0,
  lineHeight: 0,
  height: 0,
  display: "flex",
...
var Fieldset = (0, import_core47.styled)(YStack, {
  name: "Fieldset",
  tag: "fieldset",
  variants: {
    horizontal: {
...
var inputSizeVariant = /* @__PURE__ */ __name((val = "$true", extras) => {
  ...
  return !import_core48.isWeb && fontStyle && delete fontStyle.lineHeight, {
    ...fontStyle,
    ...buttonStyles,
    paddingHorizontal
  };
...
function useInputProps(props, ref) {
  var _a, _b;
  const theme = (0, import_core49.useTheme)(), { onChangeText, ref: combinedRef } = (0, import_focusable4.useFocusable)({
    props,
    ref,
    isInput: true
...
var Spinner = YStack.extractable(
  (0, import_core51.themeable)(
    React38.forwardRef((props, ref) => {
      const { size: size2, color: colorProp, ...stackProps } = props, theme = (0, import_core51.useTheme)();
      let color = colorProp;
      return color && color[0] === "$" && (color = (0, import_core51.variableToString)(theme[color])), /* @__PURE__ */ (0, import_jsx_runtime49.jsx)(YStack, { ref, ...stackProps, children: /* @__PURE__ */ (0, import_jsx_runtime49.jsx)(import_react_native14.ActivityIndicator, { size: size2, color }) });
    }),
    {
